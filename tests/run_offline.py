...
COMMANDS = [
    ...
    [sys.executable, "tests/test_opencode_binary_resolution.py"],
    ...
    [sys.executable, "tests/test_story_writer_diagnostics.py"],
    ...
    [
        sys.executable,
        "workspace/social/ops/scripts/nullone_heartbeat.py",
        "self-test",
    ],
    [
        sys.executable,
    ...
    [
        sys.executable,
        "workspace/social/ops/scripts/nullone_opencode_binary.py",
        "self-test",
    ],
    [
        sys.executable,
    ...
    [
        sys.executable,
        "workspace/social/ops/scripts/nullone_opencode_story_provider.py",
        "self-test",
    ],
    [
        sys.executable,
        "workspace/social/ops/scripts/nullone_story_provider_factory.py",
        "self-test",
    ],
    [
        sys.executable,
